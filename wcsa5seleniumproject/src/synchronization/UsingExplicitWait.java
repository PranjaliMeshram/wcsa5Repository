...
public class UsingExplicitWait {
	public static void main(String[] args) {
		...
		explicitWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//img[@alt='Nehru jacket']"))).click();
		//driver.findElement(By.xpath("//img[@alt='HOODIES']")).click();


		driver.findElement(By.xpath("//input[@id='Check Delivery']")).sendKeys("442403");
